      ...
      {open && (
        ...
        >
          <div className="flex flex-col gap-3 pt-3">
            <Link href="/qa" className="hover:text-white" data-testid="mobile-menu-qna" onClick={() => setOpen(false)}>ChatGPT Q&A</Link>
            <Link href="/blog" className="hover:text-white" data-testid="mobile-menu-blog" onClick={() => setOpen(false)}>Blog</Link>
